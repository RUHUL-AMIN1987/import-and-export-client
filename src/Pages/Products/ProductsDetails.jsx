...
const ProductsDetails = () => {
    ...
    useEffect(() => {
        fetch(`https://smart-deals-app.vercel.app/products/bids/${_id}`)
            .then(res => res.json())
    ...
    const handleBidSubmit = (e) => {
        ...
        fetch("https://smart-deals-app.vercel.app/bids", {
            method: "POST",
            headers: {
    ...
    return (
        <div className="container mx-auto p-4">
            ...
            <div className="text-center mb-8">
                <button onClick={handleMoralUse} className="btn btn-primary px-6 py-3 text-white font-medium rounded-lg">
                    ...
                    <div className="grid gap-3">
                        {bids.map((bid) => (
                            <div key={bid._id} className="bg-gray-50 p-4 rounded-lg border">
                                <p>
                                    <strong>{bid.buyer_name}</strong> offered <strong>${bid.bid_price}</strong>
                                </p>
